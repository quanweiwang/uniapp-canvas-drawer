...
**uni-app** [uniapp-canvas-drawer](https://github.com/quanweiwang/uniapp-canvas-drawer/)  
**mpvue** [mpvue_canvas_drawer](https://github.com/kuckboy1994/mpvue_canvas_drawer/)。

做 **uni-app** 中好用的 `canvas` 绘图组件之一。
...
- `git clone https://github.com/quanweiwang/uniapp-canvas-drawer` 到本地
- 把 `components` 中的 `uniapp-canvas-drawer` 拷贝到自己项目下。
- 在使用页面注册组件
```json
{
    "usingComponents": {
...
- 当前栗子中的 `painting` 简单展示一下。详细配置请看 [API](https://github.com/quanweiwang/uniapp-canvas-drawer#api)
